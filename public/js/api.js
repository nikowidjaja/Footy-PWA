...
function getSavedTeams() {
  getAll().then(function (teams) {
    ...
    teams.forEach((team) => {
      ...
      myTeamHTML += `
  <div class="myteam__team">
    <p>${team.name}</p>
    <img src="${team.crestUrl}" />
    <div class="myteam__team__detail" onclick="window.location='team.html?id=${team.id}'">Detail</div>
    <div class="myteam__team__delete" onclick="deleteFromDb(${team.id})">Delete</div>
  </div>
  `;
    })
